...
\titolo{Realizzazione di un sistema di rilevazione e prevenzione delle intrusioni con Snort}
\autore{Allegra Strippoli}
\matricola{548288}
...
% dati opzionali
\dedica{A ship in harbor is safe, but that is not what ships are built for. -
John Augustus Shedd} % solo se nel documento si usa il comando \generaDedica
...
\capitolo{Sicurezza della rete}{capitolo-1}
\capitolo{Snort: un IDS/IPS network-based}{capitolo-2}
\capitolo{Requisiti}{capitolo-3}
\capitolo{Realizzazione}{capitolo-4}
\capitolo{Installazione e configurazione di Snort}{capitolo-5}
\capitolo{Verifiche funzionali}{capitolo-6}
